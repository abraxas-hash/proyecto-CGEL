  ...
  return (
    <div className="space-y-6 mt-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 glass-panel rounded-3xl p-6 border border-white/5 bg-gradient-to-br from-white/[0.02] to-transparent">
          <h3 className="text-xs font-black text-gray-500 uppercase tracking-[0.2em] mb-6">Distribución de Carga</h3>
        ...
        <div className="lg:col-span-8 glass-panel rounded-3xl p-6 border border-white/5 bg-gradient-to-br from-white/[0.02] to-transparent">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-xs font-black text-gray-500 uppercase tracking-[0.2em]">Flujo de Ingresos (Picos de Carga)</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 glass-panel rounded-3xl p-6 border border-white/5 bg-gradient-to-br from-white/[0.02] to-transparent">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h3 className="text-xs font-black text-gray-500 uppercase tracking-[0.2em]">Análisis de Afluencia Semanal</h3>
