        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 sm:mt-1 font-black uppercase text-[7px] sm:text-[9px] truncate">
              ...
              <span className="ml-2 text-white bg-cyan-600 px-2 py-0.5 rounded-full text-[9px] font-black animate-pulse shadow-[0_0_10px_rgba(0,212,255,0.5)]">v2.6.5-ONLINE</span>
            </p>
          </div>
        </div>
