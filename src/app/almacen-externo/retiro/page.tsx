...
import { PackageMinus, ArrowLeft, Send, CheckCircle2, Camera } from 'lucide-react';
    ...
    <div className="flex flex-col gap-5 pb-10">
      ...
      <div className="flex items-center gap-4 mt-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-black text-slate-800 dark:text-white">Retiro de Material</h2>
            <p className="text-[11px] text-red-400 font-bold uppercase tracking-wider">Almacén Externo · Salida</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="glass-panel p-4 rounded-2xl flex flex-col gap-4">
          ...
          <div>
            <label htmlFor="operario" className="text-[10px] text-slate-600 dark:text-slate-400 font-bold uppercase tracking-widest block mb-1">Operario que Retira</label>
            <input
