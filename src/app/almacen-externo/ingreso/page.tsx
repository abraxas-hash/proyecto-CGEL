      ...
      <div className="flex items-center gap-4 mt-2 mb-2">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl neumorphic-inset bg-black/5 dark:bg-white/5 flex items-center justify-center shrink-0">
            <PackagePlus className="w-6 h-6 text-green-400" />
          </div>
          <div>
            <h2 className="text-xl font-black text-slate-800 dark:text-white leading-tight">Ingreso de Material</h2>
            <p className="text-[11px] text-green-400 font-bold uppercase tracking-wider mt-0.5">Almacén Externo · Recepción</p>
          </div>
        </div>
      </div>
