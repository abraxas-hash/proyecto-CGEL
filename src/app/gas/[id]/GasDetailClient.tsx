...
export default function GasDetailClient({ proveedor, historial, evidencias }: { proveedor: any, historial: any, evidencias: any }) {
  ...
  const handleShareWhatsApp = () => {
    ...
    let message = `*Gas Montacargas: ${proveedor.empresa}*\n`;
          ...
          <div className="glass-panel rounded-2xl p-6 relative overflow-hidden border-t-4 border-t-blue-500">
            <div className="flex flex-col gap-1 mb-6 border-b border-white/10 pb-4">
              <div className="flex flex-col gap-1">
                <span className="text-[10px] text-gray-500 font-black uppercase tracking-widest">Detalle</span>
