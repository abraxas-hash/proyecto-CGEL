...
import RepartidoresClient from './RepartidoresClient';
...
export default async function RepartidoresPage() {
  ...
  if (error) {
    ...
    return (
      <div className="p-8 text-slate-800 dark:text-slate-800 dark:text-white font-[family-name:var(--font-geist-sans)]">
  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 font-[family-name:var(--font-geist-sans)] max-w-full overflow-x-hidden">
      ...
      <RepartidoresClient initialData={repartidores || []} />
    </div>
  );
}
