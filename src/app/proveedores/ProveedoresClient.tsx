      ...
      <div className="relative flex flex-col md:flex-row gap-6 flex-1 min-h-0 overflow-hidden">
        ...
        <div className="absolute bottom-4 left-2 right-2 md:hidden z-20 pointer-events-none">
          <button 
            ...
            className="w-full py-4 bg-blue-600/90 border border-blue-400/50 text-white font-black tracking-widest uppercase rounded-2xl flex items-center justify-center gap-2 shadow-[0_10px_40px_rgba(59,130,246,0.3)] backdrop-blur-xl pointer-events-auto"
          >
