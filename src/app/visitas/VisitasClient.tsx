...
export default function VisitasClient({ initialVisitas, fichasDiarias }: { initialVisitas: any[], fichasDiarias?: any[] }) {
          ...
          <div className="bg-slate-900 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] border border-slate-700">
            <div className="p-4 bg-slate-800 flex justify-between items-center border-b border-slate-700">
              <h3 className="font-bold text-white uppercase tracking-wider text-sm flex items-center gap-2">
                ...
                Ficha Física: Visitas ({selectedDate})
              </h3>
